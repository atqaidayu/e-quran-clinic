...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-navbar sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard') }}">
                <div class="sidebar-brand-text mx-3">eQuranClinic Admin</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('viewlogin') }}">Login</a>
            ...
            <div id="content">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 mb-2">
                        <div class="card border-left-primary shadow" style="height: 150px;">
                            <div class="card-body d-flex align-items-center justify-content-center">
                                <div class="text-center">
                                    <div class="text-lg font-weight-bold text-primary text-uppercase mb-1">
                                        Number of Tutors
                                    </div>
                                    <div class="h3 font-weight-bold text-gray-800">100</div>
                                </div>
                                <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-6 mb-2">
        <div class="card border-left-success shadow" style="height: 150px;">
            <div class="card-body d-flex align-items-center justify-content-center">
                <div class="text-center">
                    <div class="text-lg font-weight-bold text-primary text-uppercase mb-1">
                        Number of Learners
                    </div>
                    <div class="h3 font-weight-bold text-gray-800">3000</div>
                </div>
                <div class="col-auto">
                    <i class="fas fa-solid fa-user-graduate fa-2x text-gray-800"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6 mb-2">
        <div class="card border-left-warning shadow" style="height: 150px;">
            <div class="card-body d-flex align-items-center justify-content-center">
                <div class="text-center">
                    <div class="text-lg font-weight-bold text-primary text-uppercase mb-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Proficiency Level Analysis</h6>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Age Statistics</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="{{ route('viewlogin') }}">Logout</a>
                </div>
            </div>
        </div>
    </div>
